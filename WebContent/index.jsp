...
<body onload="getDay('${id}','${User.name}','${User.password}')">
	...
	<div id="search">
		<ul style="list-style: none;">
			...
			<li><a href="index.jsp" class="select">服务</a></li>
			<li><a href="index.jsp" class="select">公告</a></li>
			<li><a href="personalInfo.jsp" class="select">我的图书馆</a>
			
		</ul>
	</div>
	<div class="formgroup" style="margin-left: 300px">
		<select style="height: 38px">
			...
			<option>图书名称</option>
			<option>出版社名称</option>
		</select> <input class="form-control" placeholder="请输入关键字" type="text">
		<input class="searchButton" type="submit" value="书目检索" />
	</div>
	<div>
	最新公告：
	<ul style="list-style: none;">
			<li><a href="index.jsp" class="Notice">2021年图书馆报刊征订意见征集             2021.03.05</a></li>
			<li><a href="index.jsp" class="Notice">【试用资源】“新知学术发现系统”试用的通知     2021.03.01</a></li>
			<li><a href="index.jsp" class="Notice">“掌阅精选”品质阅读电子书平台开通使用 	2021.02.02</a></li>
			<li><a href="index.jsp" class="Notice">万方知识服务平台开通试用通知		2021.01.05</a></li>
			<li><a href="index.jsp" class="Notice">关于图书馆延长书库开放时间的通知		2021.01.02</a>
		</ul>
	</div>
</body>
</html>