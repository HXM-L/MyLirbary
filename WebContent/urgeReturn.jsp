...
<script type="text/javascript">
	...
	function searchRecord() {
		location.href = "finRecord.do?findURL=urgeReturn.jsp";
	}
	...
	function Delete(Rid) { /* 删除按钮 */
		...
		if (r == true) {
			console.log("确定");
			location.href = "Delete.do?AppointPage=urgeReturn&rID="+Rid;
		} else {
			console.log("取消");
			location.href = "urgeReturn.jsp";
		}
	}
					...
					<tbody>
						<c:forEach var="e" items="${UrgeList}">
							<tr>
								...
								<td>${e.overTime}</td>
								<td>
									<input type="button" value="催还" onclick="Modify(${e.borrRecordId})" /> 
