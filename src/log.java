...
public class log {
	 ...
	 * 解决方法
	 * 参考博客https://blog.csdn.net/weixin_39207535/article/details/108260666和https://www.cnblogs.com/fengzifengfeng/p/11878355.html
	 * 注意的是修改的server.xml文件是eclipse中配置好tomcat后的一个server项目里面的server.xml文件才有效
	 * */
	/*
